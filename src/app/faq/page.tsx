...
export default function FAQ() {
  ...
  const docsSecurity: QAItem[] = [
    ...
    },
    {
      ...
      a: (
        <>
          Typically: your full credit report PDF, government ID, and recent bank
          statements (business or personal). For business funding, the last 3
          months of business bank statements help a lot.
        </>
      ),
      icon: FileText,
    },
    {
      ...
      a: (
        <>
          Yes. Upload <b>PDFs only</b>. We never ask for website logins or
          passwords, and we never sell your data. Files are transmitted over
          encrypted channels.
        </>
      ),
      icon: Lock,
  ...
  return (
    <div className="bg-brand-sky">
      <div className="container py-12 md:py-16">
        {/* Top help strip */}
        <div className="rounded-xl2 border border-brand-blue/30 bg-brand-blue/10 px-5 py-4">
        ...
        <h1 className="mt-6 section-title text-brand-blue">
          Frequently Asked Questions
        </h1>
        <p className="mt-2 text-brand-navy/80 max-w-2xl">
          Short, clear answers about eligibility, documents, and timing.
        </p>

        {/* Quick jump chips */}
        <div className="mt-6 flex flex-wrap gap-2">
          <a href="#basics" className="chip bg-white hover:bg-brand-blue/10">
            Basics
          </a>
          <a href="#docs" className="chip bg-white hover:bg-brand-blue/10">
            Documents & Security
          </a>
          <a href="#apply" className="chip bg-white hover:bg-brand-blue/10">
            Apply & Funding
          </a>
        </div>
        ...
        {/* Apply & funding mini-answers */}
        <section id="apply" className="mt-10">
          <h2 className="text-xl font-extrabold tracking-tight text-brand-navy">
            Apply & Funding
          </h2>
          <div className="mt-4 grid gap-4 lg:grid-cols-3">
            <div className="card bg-brand-blue/5 border-brand-blue/30 p-5">
              <p className="font-semibold text-brand-navy">How do I apply?</p>
              <p className="mt-2 text-sm text-brand-muted">
                Fill out the short form and upload your full credit report as a
                PDF. No logins or passwords.
              </p>
            ...
            <div className="card bg-brand-blue/5 border-brand-blue/30 p-5">
              ...
              <p className="mt-2 text-sm text-brand-muted">
                We review and match you with options. If terms look good and docs
                are complete, funds can move in 24–72 hours.
              </p>
            </div>
            <div className="card bg-brand-blue/5 border-brand-blue/30 p-5">
              <p className="font-semibold text-brand-navy">Under 600 FICO?</p>
              <p className="mt-2 text-sm text-brand-muted">
                Start with Credit Assistance to rebuild, then re-apply. We’ll
                guide you.
              </p>
              <Link href="/credit-assistance" className="btn-outline mt-4">
                Credit Assistance
              </Link>
            </div>
          </div>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-[1fr,1fr]">
          <div className="rounded-xl2 border border-brand-blue/40 bg-brand-blue/10 p-6">
